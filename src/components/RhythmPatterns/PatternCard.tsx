  ...
  return (
    <div
      className={`
        ...
        ${isActive
          ? 'border-primary-500 bg-gray-800/80 shadow-lg shadow-primary-500/10'
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex-1 min-w-0">
          <h3 className="text-lg font-semibold text-white truncate">{pattern.name}</h3>
      ...
      <div className="flex flex-wrap gap-1.5 mb-3">
        ...
        <span className="text-xs px-2 py-0.5 rounded-full bg-gray-700/50 text-gray-300 border border-gray-600">
      ...
      {/* Text notation */}
      <div className="mb-3 px-3 py-2 bg-gray-900/60 rounded-lg font-mono text-sm text-gray-300 overflow-x-auto">
        {pattern.notation}
      </div>
