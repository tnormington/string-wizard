...
export function KeyboardShortcutsHelp({ shortcuts, onClose }: KeyboardShortcutsHelpProps) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-2xl w-full max-w-lg mx-3 sm:mx-4 max-h-[80vh] overflow-y-auto">
        {/* Header */}
              ...
              <div className="space-y-2">
                {group.items.map((shortcut) => (
                  ...
                  >
                    ...
                    <kbd className="ml-4 px-2 py-1 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded text-xs text-gray-700 dark:text-gray-200 font-mono whitespace-nowrap">
